// Automatically generated with: gastly ../../holdme/internal/keysorderedbyvalues.go desirednodes.go lowring NumericKeyType=droptype:Node NumericValueType=droptype:int32 KeysOrderedByValues=desiredNodes Newd=newD Keys=byDesire Values=toDesire
